...
PSYCO_DATA = {
    'long48000': [
        ...
        { 'cbw': 3, 'bu': 1, 'bo':14, 'w1': 0.833, 'w2': 0.722 },
        { 'cbw': 3, 'bu': 4, 'bo':17, 'w1': 0.278, 'w2': 0.639 },
        { 'cbw': 2, 'bu': 7, 'bo':19, 'w1': 0.361, 'w2': 0.417 },
        { 'cbw': 3, 'bu': 9, 'bo':22, 'w1': 0.583, 'w2': 0.083 },
        { 'cbw': 2, 'bu': 2, 'bo':24, 'w1': 0.917, 'w2': 0.750 },
        { 'cbw': 3, 'bu': 4, 'bo':27, 'w1': 0.250, 'w2': 0.417 },
        { 'cbw': 3, 'bu': 7, 'bo':30, 'w1': 0.583, 'w2': 0.648 },
        { 'cbw': 3, 'bu': 0, 'bo':33, 'w1': 0.352, 'w2': 0.611 },
        { 'cbw': 3, 'bu': 3, 'bo':36, 'w1': 0.389, 'w2': 0.625 },
        { 'cbw': 4, 'bu': 6, 'bo':40, 'w1': 0.375, 'w2': 0.144 },
        { 'cbw': 3, 'bu': 0, 'bo':43, 'w1': 0.856, 'w2': 0.389 },
        { 'cbw': 3, 'bu': 3, 'bo':46, 'w1': 0.611, 'w2': 0.160 },
        { 'cbw': 3, 'bu': 6, 'bo':49, 'w1': 0.840, 'w2': 0.217 },
        { 'cbw': 3, 'bu': 9, 'bo':52, 'w1': 0.783, 'w2': 0.184 },
        { 'cbw': 2, 'bu': 2, 'bo':54, 'w1': 0.816, 'w2': 0.886 },
        { 'cbw': 3, 'bu': 4, 'bo':57, 'w1': 0.114, 'w2': 0.313 },
        { 'cbw': 2, 'bu': 7, 'bo':59, 'w1': 0.687, 'w2': 0.452 },
        { 'cbw': 1, 'bu': 9, 'bo':60, 'w1': 0.548, 'w2': 0.908 },
    ],
    'long44100': [
        { 'cbw': 3, 'bu': 0, 'bo': 4, 'w1': 1.000, 'w2': 0.056 },
        { 'cbw': 3, 'bu': 4, 'bo': 7, 'w1': 0.944, 'w2': 0.611 },
        { 'cbw': 4, 'bu': 7, 'bo':11, 'w1': 0.389, 'w2': 0.167 },
        { 'cbw': 3, 'bu': 1, 'bo':14, 'w1': 0.833, 'w2': 0.722 },
        { 'cbw': 3, 'bu': 4, 'bo':17, 'w1': 0.278, 'w2': 0.139 },
        { 'cbw': 1, 'bu': 7, 'bo':18, 'w1': 0.861, 'w2': 0.917 },
        { 'cbw': 3, 'bu': 8, 'bo':21, 'w1': 0.083, 'w2': 0.583 },
        { 'cbw': 3, 'bu': 1, 'bo':24, 'w1': 0.417, 'w2': 0.250 },
        { 'cbw': 3, 'bu': 4, 'bo':27, 'w1': 0.750, 'w2': 0.805 },
        { 'cbw': 3, 'bu': 7, 'bo':30, 'w1': 0.194, 'w2': 0.574 },
        { 'cbw': 3, 'bu': 0, 'bo':33, 'w1': 0.426, 'w2': 0.537 },
        { 'cbw': 3, 'bu': 3, 'bo':36, 'w1': 0.463, 'w2': 0.819 },
        { 'cbw': 4, 'bu': 6, 'bo':40, 'w1': 0.180, 'w2': 0.100 },
        { 'cbw': 3, 'bu': 0, 'bo':43, 'w1': 0.900, 'w2': 0.468 },
        { 'cbw': 3, 'bu': 3, 'bo':46, 'w1': 0.532, 'w2': 0.623 },
        { 'cbw': 3, 'bu': 6, 'bo':49, 'w1': 0.376, 'w2': 0.450 },
        { 'cbw': 3, 'bu': 9, 'bo':52, 'w1': 0.550, 'w2': 0.552 },
        { 'cbw': 3, 'bu': 2, 'bo':55, 'w1': 0.448, 'w2': 0.403 },
        { 'cbw': 2, 'bu': 5, 'bo':57, 'w1': 0.597, 'w2': 0.643 },
        { 'cbw': 2, 'bu': 7, 'bo':59, 'w1': 0.357, 'w2': 0.722 },
        { 'cbw': 2, 'bu': 9, 'bo':61, 'w1': 0.278, 'w2': 0.960 },
    ],
    'long32000': [
        ...
        { 'cbw': 3, 'bu': 1, 'bo':14, 'w1': 0.583, 'w2': 0.083 },
        { 'cbw': 2, 'bu': 4, 'bo':16, 'w1': 0.917, 'w2': 0.750 },
        { 'cbw': 3, 'bu': 6, 'bo':19, 'w1': 0.250, 'w2': 0.870 },
        { 'cbw': 3, 'bu': 9, 'bo':22, 'w1': 0.130, 'w2': 0.833 },
        { 'cbw': 4, 'bu': 2, 'bo':26, 'w1': 0.167, 'w2': 0.389 },
        { 'cbw': 4, 'bu': 6, 'bo':30, 'w1': 0.611, 'w2': 0.478 },
        { 'cbw': 4, 'bu': 0, 'bo':34, 'w1': 0.522, 'w2': 0.033 },
        { 'cbw': 3, 'bu': 4, 'bo':37, 'w1': 0.967, 'w2': 0.917 },
        { 'cbw': 4, 'bu': 7, 'bo':41, 'w1': 0.083, 'w2': 0.617 },
        { 'cbw': 3, 'bu': 1, 'bo':44, 'w1': 0.383, 'w2': 0.995 },
        { 'cbw': 4, 'bu': 4, 'bo':48, 'w1': 0.005, 'w2': 0.274 },
        { 'cbw': 3, 'bu': 8, 'bo':51, 'w1': 0.726, 'w2': 0.480 },
        { 'cbw': 3, 'bu': 1, 'bo':54, 'w1': 0.519, 'w2': 0.261 },
        { 'cbw': 2, 'bu': 4, 'bo':56, 'w1': 0.739, 'w2': 0.884 },
        { 'cbw': 2, 'bu': 6, 'bo':58, 'w1': 0.116, 'w2': 1.000 },
    ],
    'short48000': [
        ...
        { 'cbw': 4, 'bu': 1, 'bo':15, 'w1': 0.833, 'w2': 0.167 },
        { 'cbw': 4, 'bu': 5, 'bo':19, 'w1': 0.833, 'w2': 0.583 },
        { 'cbw': 3, 'bu': 9, 'bo':22, 'w1': 0.417, 'w2': 0.917 },
        { 'cbw': 4, 'bu': 2, 'bo':26, 'w1': 0.083, 'w2': 0.944 },
        { 'cbw': 4, 'bu': 6, 'bo':30, 'w1': 0.055, 'w2': 0.042 },
        { 'cbw': 2, 'bu': 0, 'bo':32, 'w1': 0.958, 'w2': 0.567 },
        { 'cbw': 3, 'bu': 2, 'bo':35, 'w1': 0.433, 'w2': 0.167 },
        { 'cbw': 2, 'bu': 5, 'bo':37, 'w1': 0.833, 'w2': 0.618 },
    ],
    'short44100': [
        { 'cbw': 2, 'bu': 0, 'bo': 2, 'w1': 1.000, 'w2': 0.167 },
        { 'cbw': 2, 'bu': 3, 'bo': 5, 'w1': 0.833, 'w2': 0.833 },
        ...
        { 'cbw': 3, 'bu': 8, 'bo':11, 'w1': 0.500, 'w2': 0.167 },
        { 'cbw': 4, 'bu': 1, 'bo':15, 'w1': 0.833, 'w2': 0.167 },
        { 'cbw': 5, 'bu': 5, 'bo':20, 'w1': 0.833, 'w2': 0.250 },
        { 'cbw': 3, 'bu': 0, 'bo':23, 'w1': 0.750, 'w2': 0.583 },
        { 'cbw': 4, 'bu': 3, 'bo':27, 'w1': 0.417, 'w2': 0.055 },
        { 'cbw': 3, 'bu': 7, 'bo':30, 'w1': 0.944, 'w2': 0.375 },
        { 'cbw': 3, 'bu': 0, 'bo':33, 'w1': 0.625, 'w2': 0.300 },
        { 'cbw': 3, 'bu': 3, 'bo':36, 'w1': 0.700, 'w2': 0.167 },
        { 'cbw': 2, 'bu': 6, 'bo':38, 'w1': 0.833, 'w2': 1.000 },
    ],
    'short32000': [
        { 'cbw': 2, 'bu': 0, 'bo': 2, 'w1': 1.000, 'w2': 0.167 },
        { 'cbw': 2, 'bu': 3, 'bo': 5, 'w1': 0.833, 'w2': 0.833 },
        ...
        { 'cbw': 4, 'bu': 1, 'bo':15, 'w1': 0.833, 'w2': 0.167 },
        { 'cbw': 5, 'bu': 5, 'bo':20, 'w1': 0.833, 'w2': 0.250 },
        { 'cbw': 4, 'bu': 0, 'bo':24, 'w1': 0.750, 'w2': 0.250 },
        { 'cbw': 5, 'bu': 4, 'bo':29, 'w1': 0.750, 'w2': 0.055 },
        { 'cbw': 4, 'bu': 9, 'bo':33, 'w1': 0.944, 'w2': 0.375 },
        { 'cbw': 4, 'bu': 3, 'bo':37, 'w1': 0.625, 'w2': 0.472 },
        { 'cbw': 3, 'bu': 7, 'bo':40, 'w1': 0.528, 'w2': 0.937 },
        { 'cbw': 1, 'bu': 0, 'bo':41, 'w1': 0.062, 'w2': 1.000 },
    ]
}
